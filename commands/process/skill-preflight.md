...
**Use `scripts/metadata-validator.js`** for all metadata validation checks. Check if `scripts/metadata-validator.js` exists locally. If not, copy from `${CLAUDE_PLUGIN_ROOT}/script-templates/metadata-validator.js`.
