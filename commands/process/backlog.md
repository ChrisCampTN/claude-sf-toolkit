...
For each script below, check for a local copy in the project's `scripts/` directory first. If not found, generate it from the plugin's `script-templates/` directory (e.g., `script-templates/backlog-render.js`).
